...
class Evento (models.Model):
    ...
    horasIni = models.IntegerField(validators=[MinValueValidator(1)], null=True, blank=True)
    horasFin = models.IntegerField(validators=[MinValueValidator(1)], null=True, blank=True)
    horasDura = models.TimeField(validators=[MinValueValidator(1)],null=True, blank=True)
    local = models.TextField(max_length=200)
    quantPart = models.IntegerField(validators=[MinValueValidator(1)])
